...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        // $sum_prix_unitaire = DB::table('produits')->sum('prix_unitaire');
        ...
        $prix_unitaire = Produit::select(DB::raw("SUM(prix_unitaire) as sum_pu"))->whereYear('created_at',date('Y'))->groupBy(DB::raw("Month(created_at)"))->pluck("sum_pu");
        ...
        foreach($months_pu as $index => $month){
            $data_produit_pu[$month-1] = $prix_unitaire[$index];
        }
