...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
       $permissions=[
        ...
        'stock-list','stock-create','stock-destroy',
        ...
        'groupe-create','groupe-edit','groupe-list','groupe-show','groupe-destroy',
        ...
        'entreprise-create','entreprise-edit','entreprise-list','entreprise-show','entreprise-destroy',
        "transaction-edit","transaction-destroy","transaction-create","transaction-list",
        "venteSemaine-list","venteSemaine-destroy","venteSemaine-show","venteSemaine-create",
