        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="row row-cols-3">
                    <div class="col">
                        <button type="button" class="btn btn-primary w-100 text-uppercase" data-bs-toggle="modal" data-bs-target="#add">
                            <span class="mdi mdi-plus-circle-outline align-middle"></span>
                            <span>Ajouter autre caractéristique</span>
                        </button>
                    </div>
                    <div class="col">
                        <button type="button" class="btn btn-primary w-100 text-uppercase" data-bs-toggle="modal" data-bs-target="#add-category">
                            <span class="mdi mdi-plus-circle-outline align-middle"></span>
                            <span>Ajouter autre catégorie</span>
                        </button>
                    </div>
                    <div class="col">
                        <button type="button" class="btn btn-primary w-100 text-uppercase" data-bs-toggle="modal" data-bs-target="#add-sous-category">
                            <span class="mdi mdi-plus-circle-outline align-middle"></span>
                    ...
                    <div class="row row-cols-md-2 row-cols-1">
                        ...
                        <div class="col mb-2">
                            <div class="form-group">
                                ...
                                <textarea name="description" id=""  rows="3" class="form-control" value="{{ $produit->description }}">{{ $produit->description }}</textarea>
                            </div>
                        </div>
                        <div class="col mb-2">
                            <div class="form-group">
            ...
            <table class="table table-striped m-0 table-sm">
                ...
                <tbody>
                    @forelse ($produit->caracteristiques as $pro_caracteristique)
                        ...
                        <div class="modal fade" id="edit{{ $pro_caracteristique->id }}" tabindex="-1" aria-labelledby="varyingModalLabel" aria-hidden="true">forelse
