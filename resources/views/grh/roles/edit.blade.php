        ...
        <div class="table-responsive">
            <table class="table table-bordered table-sm m-0">
                <tbody>
                    ...
                    <tr>
                        <th class="table-success col-lg-2 col-4 align-middle text-center">ligne achats</th>
                        <td class="align-middle">
                            <ul class="list-group">
                                <div class="row row-cols-lg-6 row-cols-md-2 row-cols-1 m-0">
                                    @foreach($ligne_achats as $ligne_achat)
                                        <div class="col mb-lg-0 mb-2">
                                            <label class="list-group-item py-1 d-flex justify-content-center m-0" style="cursor: pointer;" for="swithe{{ $ligne_achat->id }}">
                                                <div class="form-check form-switch">
                                                    {{ Form::checkbox('permission_u[]', $ligne_achat->id, in_array($ligne_achat->id, $rolePermissions) ? true : false, array('class' => 'form-check-input','id'=>'swithe'.$ligne_achat->id)) }}
                    ...
                    <tr>
                        <th class="table-success col-lg-2 col-4 align-middle text-center">achat paiements</th>
                        <td class="align-middle">
                            <ul class="list-group">
                                <div class="row row-cols-lg-6 row-cols-md-2 row-cols-1 m-0">
                                    @foreach($achat_paiements as $achat_paiement)
                                        <div class="col mb-lg-0 mb-2">
                                            <label class="list-group-item py-1 d-flex justify-content-center m-0" style="cursor: pointer;" for="swithe{{ $achat_paiement->id }}">
                                                <div class="form-check form-switch">
                                                    {{ Form::checkbox('permission_u[]', $achat_paiement->id, in_array($achat_paiement->id, $rolePermissions) ? true : false, array('class' => 'form-check-input','id'=>'swithe'.$achat_paiement->id)) }}
                    ...
                    <tr>
                        <th class="table-success col-lg-2 col-4 align-middle text-center">fournisseurs</th>
                        <td class="align-middle">
                            <ul class="list-group">
                                <div class="row row-cols-lg-6 row-cols-md-2 row-cols-1 m-0">
                                    @foreach($fournisseurs as $fournisseur)
                                        <div class="col mb-lg-0 mb-2">
                                            <label class="list-group-item py-1 d-flex justify-content-center m-0" style="cursor: pointer;" for="swithe{{ $fournisseur->id }}">
                                                <div class="form-check form-switch">
                                                    {{ Form::checkbox('permission_u[]', $fournisseur->id, in_array($fournisseur->id, $rolePermissions) ? true : false, array('class' => 'form-check-input','id'=>'swithe'.$fournisseur->id)) }}
