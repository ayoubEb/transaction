...
<div class="d-flex justify-content-between mb-2">
    <h5 class="m-0">Modifier le produit : {{ $produit->reference ?? "" }}</h5>
            ...
            <div class="card">
                <div class="card-body p-2">
                    <div class="row row-cols-md-2 row-cols-1">
                        ...
                        <div class="col mb-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="prix_unitaire" id="" class="form-control  @error('prix_unitaire') is-invalid @enderror" value="{{ $produit->prix_unitaire }}">
                                @error('prix_unitaire')
                                    <span class="invalid-feedback">
                                        {{ $message }} ex : 0/0.00
                                    </span>
                        ...
                        <div class="col mb-2">
                            <div class="form-group">
                                ...
                                <input type="number" name="quantite" min="1"  id="" class="form-control  @error('quantite') is-invalid @enderror" value="{{ $produit->quantite }}">
                                @error('quantite')
                                    <span class="invalid-feedback">{{$message}}</span>
                                @enderror
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id=""  rows="5" class="form-control" value="{{ $produit->description }}"></textarea>
                    </div>
                </div>
            </div>
        </div>
